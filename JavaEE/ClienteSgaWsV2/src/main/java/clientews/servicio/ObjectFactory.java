...
public class ObjectFactory {
    ...
    private final static QName _Persona_QNAME = new QName("http://servicio.sga.nglcode.com/", "persona");
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.sga.nglcode.com/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.sga.nglcode.com/", "listarPersonasResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.nglcode.com/", name = "persona")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.nglcode.com/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.nglcode.com/", name = "listarPersonasResponse")
