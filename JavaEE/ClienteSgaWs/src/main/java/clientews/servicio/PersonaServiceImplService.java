 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.sga.nglcode.com/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.sga.nglcode.com/", "PersonaServiceImplService");
    ...
    public PersonaServiceWs getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.sga.nglcode.com/", "PersonaServiceImplPort"), PersonaServiceWs.class);
    }
    ...
    public PersonaServiceWs getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.sga.nglcode.com/", "PersonaServiceImplPort"), PersonaServiceWs.class, features);
    }
